...
void IMUFilter::getPitchAngle(IMUData& imuData) {
  ...
  Serial.print("rpa:");
  Serial.print(computeAccelerometerPitch(ax, ay, az));
  Serial.print(", ");
  ...
  Serial.print("fpa:");
  Serial.print(pitchAccelerometer, 4);
  Serial.print(", ");
  ...
  Serial.print("pg:");
  Serial.print(pitchGyro, 4);
  Serial.print(", ");

  // Complementary filter to combine the gyro and accelerometer angle
  // Filtered Angle = α × (Gyroscope Angle) + (1 − α) × (Accelerometer Angle)
  lastPitchValue = 0.96 * pitchGyro + 0.04 * pitchAccelerometer;

  Serial.print("pc:");
  Serial.print(lastPitchValue, 4);
  Serial.println();
